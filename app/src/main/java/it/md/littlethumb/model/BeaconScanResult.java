 ...
 * Email: frig@frig.at
 */
package it.md.littlethumb.model;
 ...
 */
@DatabaseTable(tableName = BeaconScanResult.TABLE_NAME)
public class BeaconScanResult extends BaseDaoEnabled<BeaconScanResult, Integer> {
	...
	public BeaconScanResult(long timestamp, Location location, ProjectSite projectLocation) {
	 ...
	 * @param copy
	 */
	public BeaconScanResult(BeaconScanResult copy) {
	...
	public void save(DatabaseHelper databaseHelper) throws SQLException {
		...
		Dao<BeaconScanResult, Integer> scanResultDao = databaseHelper.getDao(BeaconScanResult.class);
